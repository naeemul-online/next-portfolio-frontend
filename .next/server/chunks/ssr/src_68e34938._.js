...
const register = async (data)=>{
    const res = await fetch(`${("TURBOPACK compile-time value", "https://next-portfolio-backend-tau.vercel.app/api/v1")}/user`, {
        method: "POST",
        headers: {
...
function LoginPage() {
    ...
    const onSubmit = async (data)=>{
        setIsLoading(true);
        try {
            const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$actions$2f$auth$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["login"])(data);
            console.log("Res: =============>", res);
        } catch (error) {
...
//# sourceMappingURL=src_68e34938._.js.map