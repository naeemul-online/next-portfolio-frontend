...
const register = async (data)=>{
    const res = await fetch("".concat(("TURBOPACK compile-time value", "https://next-portfolio-backend-tau.vercel.app/api/v1"), "/user"), {
        method: "POST",
        headers: {
...
const login = async (data)=>{
    ...
    const res = await fetch("".concat(("TURBOPACK compile-time value", "https://next-portfolio-backend-tau.vercel.app/api/v1"), "/auth/login"), {
        method: "POST",
        headers: {
            "Content-Type": "application/json"
        },
    ...
    if (responseData.success && ((_responseData_data = responseData.data) === null || _responseData_data === void 0 ? void 0 : _responseData_data.token)) {
        console.log("Login successful and token set in cookie");
        return responseData;
    } else {
...
function LoginPage() {
    ...
    const onSubmit = async (data)=>{
        setIsLoading(true);
        try {
            const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$actions$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["login"])(data);
            console.log("Res: =============>", res);
        } catch (error) {
...
//# sourceMappingURL=src_ac6d0aad._.js.map